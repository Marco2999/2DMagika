...
public class Tree extends StaticEntity {
    ...
    @Override
    public void die() {
        handler.getWorld().getItemManager().addItem(Item.attackItm.createNew((int)x + bounds.x,(int)y + bounds.y,1));
        handler.getWorld().getItemManager().addItem(Item.woodItem.createNew((int)x + bounds.x +100,(int)y + bounds.y,1));
